...
def main():
    ...
    print(f"Serveur HTTP simulant l'API CR1000 Datalogger sur http://0.0.0.0:8765")
    print(f"Essai local : http://localhost:8765/?command=DataQuery&uri=MeteoPau&format=json&mode=most-recent&p1=10")
